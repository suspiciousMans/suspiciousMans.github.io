import{r as g,j as I}from"./index-Cq74twPa.js";import{u as J,T as X}from"./ToyTools-Cae8KJXy.js";import{T as Y,c as Z,a as L,b as K}from"./ToyPanel-BDDifveB.js";import{u as Q,a as U,O as V,c as _,s as ee,d as te,t as ne}from"./OxToy-D1NGODRq.js";const q={small:{W:48,H:30,label:"Small · 48 × 30"},medium:{W:64,H:40,label:"Medium · 64 × 40"},large:{W:96,H:60,label:"Large · 96 × 60"}},C=4,re=Float32Array.from([0,8,2,10,12,4,14,6,3,11,1,9,15,7,13,5],s=>(s+.5)/16),D=`// Runs for every cell of the grid, every frame.
