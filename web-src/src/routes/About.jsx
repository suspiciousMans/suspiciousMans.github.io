                ...
                <div className="about-layout">
                    ...
                    <div className="about-content">
                        <p className="reveal" data-reveal>
                            As you may know. I enjoy a lot of suspicious things — touching grass (occasionally),
                            Assembly, and Rust. I dream in JavaScript and exist in binary. Send help.
                        </p>
                        <p className="reveal" data-reveal style={{ transitionDelay: "80ms" }}>
                            ...
                            engines, hex-grid colony builders, and whatever project currently has my attention. Most
                            of it ends up written in Rust, because I enjoy fighting the borrow checker more than is
                            probably healthy.
                        </p>
                        <p className="reveal" data-reveal style={{ transitionDelay: "160ms" }}>
                            Right now most of my time goes into <Link to="/hex-colony.html">Hex Colony</Link>, a
                            turn-based pixel-art colony builder, and the little engine underneath it. Everything I
                            ship publicly is linked from the <Link to="/projects.html">projects page</Link>.
                        </p>
