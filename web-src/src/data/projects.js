...
const projects = [
    ...
    },
    {
        ...
        tags: ["React", "Vite"],
        description:
            "A single-page React + Vite app on GitHub Pages. Onyx and lilac ash, serif type, seamless navigation, a Lab for interactive experiments, and a music player that doesn't restart every time you click a link.",
